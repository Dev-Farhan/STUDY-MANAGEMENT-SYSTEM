...
const TextArea: React.FC<TextareaProps> = ({
  ...
  if (disabled) {
    ...
    textareaClasses += `bg-transparent  border-error-500 focus:border-error-300 focus:ring-error-500/10 dark:bg-gray-900 dark:text-white/90  dark:text-error-400 dark:border-error-500 dark:focus:border-error-800 `;
  }
  //  else if (error) {
